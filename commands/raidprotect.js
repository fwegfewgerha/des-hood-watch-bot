...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (sub === 'on') {
      ...
      // Flip these immediately — before awaiting the (slower) channel locks —
      // so auto-kick protection is live from the moment the command is run,
      // not from whenever every channel finishes getting locked.
